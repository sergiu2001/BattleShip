...
/**
 * @extends ServiceEntityRepository<Battles>
 *
...
class BattlesRepository extends ServiceEntityRepository
{
    ...
    public function add(Battles $entity, bool $flush = false): void
    {
    ...
    public function remove(Battles $entity, bool $flush = false): void
    {
...
//    /**
//     * @return Battles[] Returns an array of Battles objects
//     */
...
//    public function findOneBySomeField($value): ?Battles
//    {
//        return $this->createQueryBuilder('b')
//            ->andWhere('b.exampleField = :val')
//            ->setParameter('val', $value)
